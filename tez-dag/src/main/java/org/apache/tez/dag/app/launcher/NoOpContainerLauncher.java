...
public class NoOpContainerLauncher extends DagContainerLauncher {
  ...
  @Override
  public void start() {
    boolean dagDelete = org.apache.tez.runtime.library.common.shuffle.ShuffleUtils.isTezShuffleHandler(conf) &&
    ...
    boolean vertexDelete = org.apache.tez.runtime.library.common.shuffle.ShuffleUtils.isTezShuffleHandler(conf) &&
        conf.getInt(TezConfiguration.TEZ_AM_VERTEX_CLEANUP_HEIGHT,
        TezConfiguration.TEZ_AM_VERTEX_CLEANUP_HEIGHT_DEFAULT) > 0;
    boolean failedTaskAttemptDelete = org.apache.tez.runtime.library.common.shuffle.ShuffleUtils.isTezShuffleHandler(conf) &&
